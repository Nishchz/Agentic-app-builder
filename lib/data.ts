...
export const SUGGESTIONS = [
  "A smart expense tracker that automatically categorizes my monthly spending",
  "A daily habit builder that shows me a visual heatmap of my progress",
  "A personal library manager to help me track and filter the books I’ve read",
  "A simple task organizer that sends reminders based on my priorities",
  "An AI-powered mood journal that analyzes my emotions based on what I write",
  "A smart meal planner that suggests recipes based on the ingredients in my fridge"
];
